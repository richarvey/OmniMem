...
mcp_server/           # MCP server — FastMCP SSE transport
  ...
  memory/             # Core engine (shared with web_ui)
    ...
    lineage.py        # Shared engine behind set_licence/set_provenance and the web forms: stamp fields on memories and cascade to their extracted facts, never bumping updated_at
